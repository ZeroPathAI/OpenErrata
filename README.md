...
**[Chrome Web Store](https://chromewebstore.google.com/detail/openerrata/iflopmpcoifkihfimncdjkokibdfkkbd)** — Install directly from the store.

**Firefox Add-ons (AMO)** — Coming soon.

**Manual install** from [GitHub Releases](https://github.com/ZeroPathAI/openerrata/releases):

1. Download the latest browser-specific zip from the [Releases page](https://github.com/ZeroPathAI/openerrata/releases):
